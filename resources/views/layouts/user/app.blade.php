...
<head>
  ...
  <!-- CSS Libraries -->
  <link rel="stylesheet" href="{{ secure_asset('node_modules/prismjs/themes/prism.css')}}">
  {{-- Toaster --}}
  ...
  <link rel="stylesheet" href="{{ secure_asset('node_modules/selectric/public/selectric.css')}}">
  
  <!-- Template CSS -->
  <link rel="stylesheet" href="{{ secure_asset('node_modules/chocolat/dist/css/chocolat.css')}}">
